...
appstore: appstore-check
	...
	@echo "upload, one of:"
	@echo "  1. Transporter.app from the Mac App Store — drag the .pkg in."
	@echo "     Recommended: altool is deprecated and its errors are unclear."
	@echo ""
	@echo "  2. xcrun altool --upload-app -f $(APPSTORE_PKG) -t macos \\"
	@echo "       -u <your-apple-id>"
	@echo "     Omit -p and altool prompts for the app-specific password,"
	@echo "     keeping it out of shell history."